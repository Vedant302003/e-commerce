...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Shop Page (or Wishlist Page re-using logic)
    ...
    mainHeader.innerHTML = `
        <div class="container flex-between" style="height: 100%;">
            ...
            <nav class="nav-links desktop-only">
                ...
                <a href="shop.html" class="${window.location.pathname.includes('shop.html') ? 'active' : ''}">Shop</a>
                <a href="wishlist.html" class="${window.location.pathname.includes('wishlist.html') ? 'active' : ''}">Wishlist</a>
                <a href="#">Contact</a>
            </nav>
            <div class="nav-icons flex">
                <button class="btn-icon"><i data-lucide="search"></i></button>
                <a href="wishlist.html" class="btn-icon" style="display:flex;align-items:center;justify-content:center;">
                    <i data-lucide="heart" class="${wishlist.length > 0 ? 'fill-red' : ''}"></i>
                    <span class="badge" id="wishlist-count" style="${wishlist.length === 0 ? 'display:none' : ''}">${wishlist.length}</span>
                </a>
    ...
    mainFooter.innerHTML = `
        <div class="container grid footer-grid">
            <div class="footer-col">
                <h3 class="logo">LUMINA</h3>
                <p>Premium clean beauty for the modern soul. Cruelty-free, vegan, and sustainable.</p>
            ...
            <div class="footer-col">
                ...
                <p>+1 (555) 123-4567</p>
                <p>123 Beauty Lane, Los Angeles, CA</p>
            </div>
        </div>
        <div class="footer-bottom text-center">
            <p>&copy; 2026 Lumina Beauty. All rights reserved.</p>
        </div>
    `;
}
...
function updateHeaderWishlistCount() {
    renderHeader(); // brute force re-render header to update heart filled state and count
    lucide.createIcons();
}
